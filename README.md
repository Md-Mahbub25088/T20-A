...
<pre>git clone https://github.com/Md-Mahbub25088/T2.git</pre>
<pre>cd root</pre>
...
<pre>apt-get update && apt upgrade-y && apt-get install git -y && git clone https://github.com/Md-Mahbub25088/T2.git</pre>
...
# Copyright
<pre>© Copyright credits goes to Adarsh Addee. This tool is public tool anyone can use this tool.</pre>I 
